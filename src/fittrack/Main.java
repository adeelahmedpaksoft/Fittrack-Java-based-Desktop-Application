...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        UIManager.put("ComboBox.selectionBackground",  Theme.NEON_GREEN);
        ...
        UIManager.put("TextField.caretForeground",     Theme.NEON_GREEN);
        ...
        UIManager.put("ProgressBar.foreground",        Theme.NEON_GREEN);
        ...
        UIManager.put("MenuItem.selectionBackground",  Theme.NEON_GREEN);
        UIManager.put("MenuItem.selectionForeground",  Theme.TEXT_INVERSE);
        UIManager.put("Dialog.background",             Theme.BG_DARK);
